...
namespace Proto
{
    ...
    public class EnemyRenderer
    {
        ...
        /// <summary>
        /// Nilai kecepatan yang berarti "mainkan peran Attack", bukan berarti kecepatan.
        ///
        /// Gerombolan mengirim kecepatan yang sudah di-Clamp01, jadi jalur ini mustahil tersentuh
        /// olehnya — ambangnya sengaja diletakkan di atas rentang yang bisa mereka hasilkan.
        ///
        /// Yang memakainya boss bersayap, dan alasannya ia PUNYA mesin keadaan sementara
        /// gerombolan tidak. Menyembur adalah keadaan yang dipegang gameplay, bukan sesuatu yang
        /// bisa disimpulkan dari seberapa cepat badannya bergerak: naga menyembur sambil melaju
        /// maupun sambil melayang diam, dan menebaknya dari kecepatan akan salah di dua-duanya.
        /// </summary>
            ...
            Vector3 meshEuler = default, Color emission = default)
        {
            ...
            _vat.TryGet(VatRole.Attack, out _clipAttack);
        }
        ...
        {
            VatClip clip = speed01 >= AttackSpeed ? _clipAttack
                         : speed01 < 0.05f ? _clipIdle
