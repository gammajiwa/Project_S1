    ...
    public class StarterSelectPanel : MonoBehaviour
    {
        ...
        void Redraw()
        {
            ...
            if (_nameLabel != null)
            {
                ...
                // Accent hero dirancang untuk latar gelap; di perkamen KitRune ia nyaris
                // hilang ("Frostwarden" biru-es di atas krem — laporan pemilik project).
                // Digelapkan lewat HSV, bukan lerp RGB ke cokelat: lerp mencuci rona jadi
                // abu-abu, sementara menurunkan VALUE menjaga birunya tetap biru — tinta
                // gelap yang masih jelas milik grimoire es, api, atau emas.
                float hue, sat, val;
                Color.RGBToHSV(hero.Accent, out hue, out sat, out val);
                _nameLabel.color = Color.HSVToRGB(hue, Mathf.Max(sat, 0.55f), 0.34f);
            }
