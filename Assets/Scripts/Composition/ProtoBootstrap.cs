...
namespace Proto
{
    ...
    public class ProtoBootstrap : MonoBehaviour
    {
        ...
        [Tooltip("Tempat per act, bergiliran: act 1 = tempat pertama, act 2 = kedua, dst, " +
                 "membungkus kembali ke awal. Kosong = selalu memakai _biomes seperti dulu.")]
        [SerializeField] BiomePlace[] _places;
        ...
        void Awake()
        {
            ...
            // Tempat berganti per ACT: hutan, salju, ternoda, lalu membungkus. Dicek saat
            // BERANGKAT karena di detik itu layar sedang gelap oleh transisi peta — tempat baru
            // muncul saat tirai terangkat, bukan meletup di depan mata.
            //
            // Dipasang SETELAH AttachRun dengan sengaja: di dalamnya GrimoireUI MENGISI (bukan
            // menambah) run.OnEmbark — subscribe sebelum itu berarti tersapu diam-diam, persis
            // seperti OnRestEntered di bawah.
