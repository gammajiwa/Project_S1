...
namespace Proto
{
    ...
    public class GameBalance : ScriptableObject
    {
        ...
        [Tooltip("Porsi drop yang berupa RUNE. Pernah 0,25 dan itu banjir — laporan pemilik " +
                 "project: \"gw dapet rune banyak banget berkali-kali, rune harus langka\". " +
                 "Kelangkaannya dijaga jaring RunePityDrops di bawah supaya tidak jadi mustahil.")]
        [Range(0f, 1f)] public float RuneShareOfDrops = 0.1f;

        [Tooltip("Jaring pengaman kelangkaan rune: setelah sekian drop beruntun TANPA rune, " +
                 "drop berikutnya dijamin rune. Rune harus langka tapi tidak boleh mustahil — " +
                 "skill hanya bisa berdiri di atas rune, papan tanpa rune baru berhenti tumbuh " +
                 "dan pemainnya macet. 0 = jaring dimatikan.")]
        [Min(0)] public int RunePityDrops = 12;
