...
namespace Proto
{
    ...
    public class UiTheme : ScriptableObject
    {
        ...
        [Tooltip("PREFAB banner WAVE COMPLETE — muncul saat wave beres, hidup sampai pemain " +
                 "menekan LANJUT. Kode mengenali dua anak berdasarkan NAMA: 'Glow' (Image " +
                 "kilau yang alphanya dianimasikan) dan 'Label' (teks TMP yang diisi " +
                 "terjemahan). Sisanya — sprite latar, ukuran, letak — milikmu di prefab.\n\n" +
                 "Kosong = tanpa banner, seperti sebelum slot ini ada.")]
