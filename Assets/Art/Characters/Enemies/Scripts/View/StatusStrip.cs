...
namespace Proto
{
    ...
    public class StatusStrip
    {
        ...
        /// <summary>
        /// Kotak IKON slot ke-<paramref name="index"/> dalam ruang kanvas-mouse (asal
        /// kiri-bawah, satuan yang sama dengan UiMouse/GridPoint) — persegi ikonnya saja,
        /// tanpa jalur angka. Dipakai ritual reveal pakta untuk lahir tepat di ikonnya.
        /// Slot yang belum terpakai mengembalikan rect kosong; pemanggil yang memeriksa.
        /// </summary>
        public Rect IconRect(int index)
        {
            if (index < 0 || index >= _used) return new Rect(0f, 0f, 0f, 0f);
            var r = _rects[index];
            return new Rect(r.x, r.y, _icon, _icon);
        }
