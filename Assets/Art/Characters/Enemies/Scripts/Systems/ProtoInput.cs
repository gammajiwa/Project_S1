...
namespace Proto
{
    ...
    public static class ProtoInput
    {
        ...
        /// <summary>
        /// Tombol kanan mouse sedang DITAHAN — dipakai memutar kamera panggung sutradara.
        ///
        /// Terpisah dari <see cref="RightClickDown"/> dan bukan kelebihan: yang satu menjawab
        /// "baru saja ditekan" dan cuma benar selama satu frame, sementara memutar kamera adalah
        /// gerakan yang berlangsung — membacanya lewat yang lama berarti kamera bergerak satu
        /// frame lalu berhenti.
        /// </summary>
        ...
        /// <summary>
        /// Geseran mouse sejak frame lalu, dalam piksel.
        ///
        /// Diambil dari delta bawaan device, bukan dari selisih posisi yang disimpan sendiri:
        /// yang menyimpan sendiri akan melompat jauh pada frame pertama setelah jeda atau setelah
        /// kursor dikunci, dan lompatan itu membanting kamera ke sudut acak.
        /// </summary>
