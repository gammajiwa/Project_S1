...
namespace Proto
{
    ...
    public partial class PlayerCaster : MonoBehaviour
    {
        ...
        /// <summary>
        /// Kolam VFX yang sama, dibuka untuk yang BUKAN skill pemain.
        ///
        /// Semburan api naga butuh instans yang menyala terus lalu dimatikan — bukan sekali-main —
        /// dan membangun kolam kedua untuk itu berarti dua tumpukan prefab, dua Tick, dan dua
        /// tempat yang harus ingat mematikan instansnya saat run berakhir. Satu kolam yang
        /// dipinjam lebih murah daripada kolam kedua yang benar.
        /// </summary>
        public SkillVfxPool Vfx => _vfx;
